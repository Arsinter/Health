...
class Index extends ViewPU {
        ...
        GlobalInfoApi.query((result: GlobalInfo) => {
            ...
            if (result && date.getTime() < predate.getTime()) {
                AlertDialog.show({
                    ...
                    message: { "id": 16777244, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" },
                    autoCancel: false,
                    alignment: DialogAlignment.Bottom,
                    offset: { dx: 0, dy: -20 },
                    gridCount: 3,
                    confirm: {
                        value: { "id": 16777243, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" },
                        action: () => {
    ...
    TabBuilder(index: number, parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontColor(this.currentPage === index ? { "id": 16777371, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } : { "id": 16777390, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    __Common__.borderColor({ "id": 16777384, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
